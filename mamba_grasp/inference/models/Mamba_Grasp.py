...
class UNetResDecoder(nn.Module):
    def __init__(
        ...
        self.pos_output = nn.Conv2d(in_channels=96, out_channels=1, kernel_size=1, padding=0)
        self.cos_output = nn.Conv2d(in_channels=96, out_channels=1, kernel_size=1, padding=0)
        self.sin_output = nn.Conv2d(in_channels=96, out_channels=1, kernel_size=1, padding=0)
        self.width_output = nn.Conv2d(in_channels=96, out_channels=1, kernel_size=1, padding=0)
    ...
    def forward(self, skips):
        ...
        if not self.deep_supervision:
            ...
            return seg_outputs, pos_output, cos_output, sin_output, width_output

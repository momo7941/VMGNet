...
def detect_grasps(q_img, ang_img, width_img=None, no_grasps=1):
    ...
    """
    # local_max = peak_local_max(q_img, min_distance=20, threshold_abs=0.001, num_peaks=no_grasps)
    # local_max = peak_local_max(q_img, min_distance=40, threshold_abs=0.1, num_peaks=no_grasps)
